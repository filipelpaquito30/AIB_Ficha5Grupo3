...
/**
 * Job: job_4 Purpose: Infuência de partilhar<br>
 * Description: Relacionar a disponibilidade em falar sobre o estado mental e a
 * procura de tratamento. <br>
 * 
...
public class job_4 implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_4.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_1 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "job4" + "?"
				...
				globalMap.put("db_tDBConnection_1", "job4");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_FICHA_5_job_4 = new byte[0];
		static byte[] commonByteArray_FICHA_5_job_4 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FICHA_5_job_4.length) {
					if (length < 1024 && commonByteArray_FICHA_5_job_4.length == 0) {
						commonByteArray_FICHA_5_job_4 = new byte[1024];
					} else {
						commonByteArray_FICHA_5_job_4 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FICHA_5_job_4, 0, length);
				strReturn = new String(commonByteArray_FICHA_5_job_4, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FICHA_5_job_4) {
	...
	public static class PartilhamStruct implements routines.system.IPersistableRow<PartilhamStruct> {
		final static byte[] commonByteArrayLock_FICHA_5_job_4 = new byte[0];
		static byte[] commonByteArray_FICHA_5_job_4 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(PartilhamStruct other) {
	...
	public static class Nao_PartilhamStruct implements routines.system.IPersistableRow<Nao_PartilhamStruct> {
		final static byte[] commonByteArrayLock_FICHA_5_job_4 = new byte[0];
		static byte[] commonByteArray_FICHA_5_job_4 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(Nao_PartilhamStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				PartilhamStruct Partilham = new PartilhamStruct();
				row4Struct row4 = new row4Struct();
				row5Struct row5 = new row5Struct();
				Nao_PartilhamStruct Nao_Partilham = new Nao_PartilhamStruct();
				...
				String tableName_tDBOutput_1 = "partilham_tratamento";
				...
				if (dbProperties_tDBOutput_1 == null || dbProperties_tDBOutput_1.trim().length() == 0) {
					url_tDBOutput_1 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "job4" + "?"
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("job4", null, null,
						new String[] { "TABLE" })) {
					while (rsTable_tDBOutput_1.next()) {
						String table_tDBOutput_1 = rsTable_tDBOutput_1.getString("TABLE_NAME");
						if (table_tDBOutput_1.equalsIgnoreCase("partilham_tratamento")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`Age` INT(50)  ,`treatment` VARCHAR(256)  ,`care_options` VARCHAR(256)  ,`wellness_program` VARCHAR(256)  ,`anonymity` VARCHAR(256)  ,`mental_health_consequence` VARCHAR(256)  ,`coworkers` VARCHAR(256)  ,`supervisor` VARCHAR(256)  ,`mental_health_interview` VARCHAR(256)  )");
					}
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "partilham_tratamento"
						+ "` (`Age`,`treatment`,`care_options`,`wellness_program`,`anonymity`,`mental_health_consequence`,`coworkers`,`supervisor`,`mental_health_interview`) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				String tableName_tDBOutput_4 = "partilham_notratamento";
				...
				String dbProperties_tDBOutput_4 = "noDatetimeStringSync=true&serverTimezone=UTC";
				String url_tDBOutput_4 = null;
				if (dbProperties_tDBOutput_4 == null || dbProperties_tDBOutput_4.trim().length() == 0) {
					url_tDBOutput_4 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "job4" + "?"
							+ "rewriteBatchedStatements=true";
				} else {
					String properties_tDBOutput_4 = "noDatetimeStringSync=true&serverTimezone=UTC";
				...
				try (java.sql.ResultSet rsTable_tDBOutput_4 = dbMetaData_tDBOutput_4.getTables("job4", null, null,
						new String[] { "TABLE" })) {
					while (rsTable_tDBOutput_4.next()) {
						String table_tDBOutput_4 = rsTable_tDBOutput_4.getString("TABLE_NAME");
						if (table_tDBOutput_4.equalsIgnoreCase("partilham_notratamento")) {
				...
				if (!whetherExist_tDBOutput_4) {
					try (java.sql.Statement stmtCreate_tDBOutput_4 = conn_tDBOutput_4.createStatement()) {
						stmtCreate_tDBOutput_4.execute("CREATE TABLE `" + tableName_tDBOutput_4
								+ "`(`Age` INT(50)  ,`treatment` VARCHAR(256)  ,`care_options` VARCHAR(256)  ,`wellness_program` VARCHAR(256)  ,`anonymity` VARCHAR(256)  ,`mental_health_consequence` VARCHAR(256)  ,`coworkers` VARCHAR(256)  ,`supervisor` VARCHAR(256)  ,`mental_health_interview` VARCHAR(256)  ,`errorMessage` VARCHAR(255)  )");
					}
				}

				String insert_tDBOutput_4 = "INSERT INTO `" + "partilham_notratamento"
						+ "` (`Age`,`treatment`,`care_options`,`wellness_program`,`anonymity`,`mental_health_consequence`,`coworkers`,`supervisor`,`mental_health_interview`,`errorMessage`) VALUES (?,?,?,?,?,?,?,?,?,?)";
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection("Partilham" + iterateId, 0, 0);
						}
				...
				String tableName_tDBOutput_2 = "nao_partilha_tratamento";
				...
				if (dbProperties_tDBOutput_2 == null || dbProperties_tDBOutput_2.trim().length() == 0) {
					url_tDBOutput_2 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "job4" + "?"
							+ "rewriteBatchedStatements=true";
				} else {
				...
				try (java.sql.ResultSet rsTable_tDBOutput_2 = dbMetaData_tDBOutput_2.getTables("job4", null, null,
						new String[] { "TABLE" })) {
					while (rsTable_tDBOutput_2.next()) {
						String table_tDBOutput_2 = rsTable_tDBOutput_2.getString("TABLE_NAME");
						if (table_tDBOutput_2.equalsIgnoreCase("nao_partilha_tratamento")) {
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "nao_partilha_tratamento"
						+ "` (`Age`,`treatment`,`care_options`,`wellness_program`,`anonymity`,`mental_health_consequence`,`coworkers`,`supervisor`,`mental_health_interview`) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				String tableName_tDBOutput_3 = "nao_partilham_notratamento";
				...
				String dbProperties_tDBOutput_3 = "noDatetimeStringSync=true&serverTimezone=UTC";
				String url_tDBOutput_3 = null;
				if (dbProperties_tDBOutput_3 == null || dbProperties_tDBOutput_3.trim().length() == 0) {
					url_tDBOutput_3 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "job4" + "?"
							+ "rewriteBatchedStatements=true";
				} else {
					String properties_tDBOutput_3 = "noDatetimeStringSync=true&serverTimezone=UTC";
				...
				try (java.sql.ResultSet rsTable_tDBOutput_3 = dbMetaData_tDBOutput_3.getTables("job4", null, null,
						new String[] { "TABLE" })) {
					while (rsTable_tDBOutput_3.next()) {
						String table_tDBOutput_3 = rsTable_tDBOutput_3.getString("TABLE_NAME");
						if (table_tDBOutput_3.equalsIgnoreCase("nao_partilham_notratamento")) {
				...
				String insert_tDBOutput_3 = "INSERT INTO `" + "nao_partilham_notratamento"
						+ "` (`Age`,`treatment`,`care_options`,`wellness_program`,`anonymity`,`mental_health_consequence`,`coworkers`,`supervisor`,`mental_health_interview`,`errorMessage`) VALUES (?,?,?,?,?,?,?,?,?,?)";
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection("Nao_Partilham" + iterateId, 0, 0);
						}
...
// # Outputs initialization
				PartilhamStruct Partilham_tmp = new PartilhamStruct();
				Nao_PartilhamStruct Nao_Partilham_tmp = new Nao_PartilhamStruct();
// ###############################
...
// # Output table : 'Partilham'
// # Filter conditions 
								if (

								row1.coworkers.equals("Yes") && row1.supervisor.equals("Yes")
										|| row1.coworkers.equals("Some of them")
												&& row1.supervisor.equals("Some of them")
										|| row1.coworkers.equals("Yes") && row1.supervisor.equals("Some of them")
										|| row1.coworkers.equals("Some of them") && row1.supervisor.equals("Yes")

								) {
									Partilham_tmp.Age = row1.Age;
									Partilham_tmp.treatment = row1.treatment;
									Partilham_tmp.care_options = row1.care_options;
									Partilham_tmp.wellness_program = row1.wellness_program;
									Partilham_tmp.anonymity = row1.anonymity;
									Partilham_tmp.mental_health_consequence = row1.mental_health_consequence;
									Partilham_tmp.coworkers = row1.coworkers;
									Partilham_tmp.supervisor = row1.supervisor;
									Partilham_tmp.mental_health_interview = row1.mental_health_interview;
									Partilham = Partilham_tmp;
								} // closing filter/reject

// # Output table : 'Nao_Partilham'
// # Filter conditions 
								if (

								row1.coworkers.equals("No") && row1.supervisor.equals("No")

								) {
									Nao_Partilham_tmp.Age = row1.Age;
									Nao_Partilham_tmp.treatment = row1.treatment;
									Nao_Partilham_tmp.care_options = row1.care_options;
									Nao_Partilham_tmp.wellness_program = row1.wellness_program;
									Nao_Partilham_tmp.anonymity = row1.anonymity;
									Nao_Partilham_tmp.mental_health_consequence = row1.mental_health_consequence;
									Nao_Partilham_tmp.coworkers = row1.coworkers;
									Nao_Partilham_tmp.supervisor = row1.supervisor;
									Nao_Partilham_tmp.mental_health_interview = row1.mental_health_interview;
									Nao_Partilham = Nao_Partilham_tmp;
								} // closing filter/reject
// ###############################
...
// Start of branch "Partilham"
							if (Partilham != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection("Partilham" + iterateId, 1, 1);
								}
								...
								ope_tFilterRow_2.matches(
										(Partilham.treatment == null ? false
												: Partilham.treatment.compareTo("Yes") == 0),
								...
								if (ope_tFilterRow_2.getMatchFlag()) {
									...
									row4.Age = Partilham.Age;
									row4.treatment = Partilham.treatment;
									row4.care_options = Partilham.care_options;
									row4.wellness_program = Partilham.wellness_program;
									row4.anonymity = Partilham.anonymity;
									row4.mental_health_consequence = Partilham.mental_health_consequence;
									row4.coworkers = Partilham.coworkers;
									row4.supervisor = Partilham.supervisor;
									row4.mental_health_interview = Partilham.mental_health_interview;
									nb_line_ok_tFilterRow_2++;
								} else {
									if (row5 == null) {
										row5 = new row5Struct();
									}
									row5.Age = Partilham.Age;
									row5.treatment = Partilham.treatment;
									row5.care_options = Partilham.care_options;
									row5.wellness_program = Partilham.wellness_program;
									row5.anonymity = Partilham.anonymity;
									row5.mental_health_consequence = Partilham.mental_health_consequence;
									row5.coworkers = Partilham.coworkers;
									row5.supervisor = Partilham.supervisor;
									row5.mental_health_interview = Partilham.mental_health_interview;
...
// Start of branch "row4"
								if (row4 != null) {
									...
									if (row4.Age == null) {
										...
										pstmt_tDBOutput_1.setInt(1, row4.Age);
									}

									if (row4.treatment == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, row4.treatment);
									}

									if (row4.care_options == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, row4.care_options);
									}

									if (row4.wellness_program == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, row4.wellness_program);
									}

									if (row4.anonymity == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, row4.anonymity);
									}

									if (row4.mental_health_consequence == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(6, row4.mental_health_consequence);
									}

									if (row4.coworkers == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(7, row4.coworkers);
									}

									if (row4.supervisor == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(8, row4.supervisor);
									}

									if (row4.mental_health_interview == null) {
										pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(9, row4.mental_health_interview);
									}
...
// Start of branch "row5"
								if (row5 != null) {
									...
									if (row5.Age == null) {
										...
										pstmt_tDBOutput_4.setInt(1, row5.Age);
									}

									if (row5.treatment == null) {
										pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(2, row5.treatment);
									}

									if (row5.care_options == null) {
										pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(3, row5.care_options);
									}

									if (row5.wellness_program == null) {
										pstmt_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(4, row5.wellness_program);
									}

									if (row5.anonymity == null) {
										pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(5, row5.anonymity);
									}

									if (row5.mental_health_consequence == null) {
										pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(6, row5.mental_health_consequence);
									}

									if (row5.coworkers == null) {
										pstmt_tDBOutput_4.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(7, row5.coworkers);
									}

									if (row5.supervisor == null) {
										pstmt_tDBOutput_4.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(8, row5.supervisor);
									}

									if (row5.mental_health_interview == null) {
										pstmt_tDBOutput_4.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(9, row5.mental_health_interview);
									}

									if (row5.errorMessage == null) {
										pstmt_tDBOutput_4.setNull(10, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_4.setString(10, row5.errorMessage);
									}
							...
							} // End of branch "Partilham"

// Start of branch "Nao_Partilham"
							if (Nao_Partilham != null) {
								row3 = null;
								...
								if (execStat) {
									runStat.updateStatOnConnection("Nao_Partilham" + iterateId, 1, 1);
								}
								...
								ope_tFilterRow_1.matches(
										(Nao_Partilham.treatment == null ? false
												: Nao_Partilham.treatment.compareTo("Yes") == 0),
										"treatment.compareTo(\"Yes\") == 0 failed");
								...
								if (ope_tFilterRow_1.getMatchFlag()) {
									...
									row2.Age = Nao_Partilham.Age;
									row2.treatment = Nao_Partilham.treatment;
									row2.care_options = Nao_Partilham.care_options;
									row2.wellness_program = Nao_Partilham.wellness_program;
									row2.anonymity = Nao_Partilham.anonymity;
									row2.mental_health_consequence = Nao_Partilham.mental_health_consequence;
									row2.coworkers = Nao_Partilham.coworkers;
									row2.supervisor = Nao_Partilham.supervisor;
									row2.mental_health_interview = Nao_Partilham.mental_health_interview;
									nb_line_ok_tFilterRow_1++;
								} else {
									if (row3 == null) {
										row3 = new row3Struct();
									}
									row3.Age = Nao_Partilham.Age;
									row3.treatment = Nao_Partilham.treatment;
									row3.care_options = Nao_Partilham.care_options;
									row3.wellness_program = Nao_Partilham.wellness_program;
									row3.anonymity = Nao_Partilham.anonymity;
									row3.mental_health_consequence = Nao_Partilham.mental_health_consequence;
									row3.coworkers = Nao_Partilham.coworkers;
									row3.supervisor = Nao_Partilham.supervisor;
									row3.mental_health_interview = Nao_Partilham.mental_health_interview;
...
// Start of branch "row2"
								if (row2 != null) {
									...
									if (row2.Age == null) {
										...
										pstmt_tDBOutput_2.setInt(1, row2.Age);
									}

									if (row2.treatment == null) {
										pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(2, row2.treatment);
									}

									if (row2.care_options == null) {
										pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(3, row2.care_options);
									}

									if (row2.wellness_program == null) {
										pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(4, row2.wellness_program);
									}

									if (row2.anonymity == null) {
										pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(5, row2.anonymity);
									}

									if (row2.mental_health_consequence == null) {
										pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(6, row2.mental_health_consequence);
									}

									if (row2.coworkers == null) {
										pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(7, row2.coworkers);
									}

									if (row2.supervisor == null) {
										pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(8, row2.supervisor);
									}

									if (row2.mental_health_interview == null) {
										pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(9, row2.mental_health_interview);
									}
...
// ###############################      
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null || !((Boolean) resourceMap.get("inIterateVComp"))) {
						runStat.updateStatOnConnection("Partilham" + iterateId, 2, 0);
					}
				}
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null || !((Boolean) resourceMap.get("inIterateVComp"))) {
						runStat.updateStatOnConnection("Nao_Partilham" + iterateId, 2, 0);
					}
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_4.class.getClassLoader()
					.getResourceAsStream("ficha_5/job_4_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_4.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_4");
		}
...
/************************************************************************************************
 * 173574 characters generated by Talend Open Studio for Big Data on the
 * November 19, 2019 4:50:10 PM GMT
 ************************************************************************************************/